...
class RasterData {
  ...
  RasterData(this.image, this.count, this.key);
  ...
  /// Dispose this raster data, including the attached image.
  ///
  /// Will debug print if disposed more than once.
  void dispose([RenderObject? object]) {
    if (!_disposed) {
      ...
      assert(() {
        debugPrint('Warning: vector graphic image was disposed twice.\n'
            'The count was $count and the key was $key.\n'
            'The attached render object was: $object\n'
            'This is likely a bug in packag:vector_graphics, please file an '
            'issue at https://github.com/dnfield/vector_graphics .');
        return true;
      }());
    }
  }
