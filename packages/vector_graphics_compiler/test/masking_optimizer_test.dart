...
const String testString1 =
    'Only resolve MaskNode if the mask is described by a singular PathNode';
const String testString2 =
    "Don't resolve MaskNode if the mask is described by multiple PathNodes";
...
const String testString4 =
    "Don't resolve MaskNode if intersection of Mask and Path is empty";
const String testString5 = 'ParentNode and PathNode count should stay the same';

void main() {
  test(testString1, () async {
